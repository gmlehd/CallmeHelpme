...
public class Duser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secessionbtn = (ImageButton)findViewById(R.id.secession);
        ...
        goback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Duser.this, Dservice.class);
                startActivity(i);
        ...
        ValueEventListener Listener0 = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!pwd.equals(secession_edittxt.getText().toString())){
                    ...
                    Intent i = new Intent(Duser.this, DLoginActivity.class);
                    startActivity(i);
                    overridePendingTransition(0, 0);
                    finish();
                }
