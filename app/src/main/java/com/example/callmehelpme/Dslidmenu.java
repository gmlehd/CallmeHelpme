...
public class Dslidmenu extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_slidmenu);
        ...
        nightver = (ImageButton)findViewById(R.id.nightver);
        ...
        Log.i(this.getClass().getName(),"앱 실행");
        Log.i(this.getClass().getName(),"Dslidmenu loginID: "+DLoginActivity.loginID);
...
//                if (str=="man" && selected_man==true){
//                    Log.i(this.getClass().getName(),"오잉 str == man and selected_man==ture");
//                    finduser=true;
//                }
//                else if (str == "woman" && selected_woman==true){
...
//                boolean selected_woman = false;
        ...
        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dslidmenu.this, Dservice.class);
                startActivity(i);
        ...
        nightver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dslidmenu.this, Nslidmenu.class);
                startActivity(i);
                overridePendingTransition(0, 0);
                finish();
            }
...
//                Log.i(this.getClass().getName(), "오잉 path : " + path);
                    ...
                    if(!path.equals(DLoginActivity.loginID)){
                        if (callstate==true){
